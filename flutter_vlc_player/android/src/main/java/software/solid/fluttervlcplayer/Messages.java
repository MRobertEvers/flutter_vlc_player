...
public class Messages {
  ...
  public static class SpuTracksMessage {
    ...
    private Map<Object, Object> subtitles;
    public Map<Object, Object> getSubtitles() { return subtitles; }
    public void setSubtitles(Map<Object, Object> setterArg) { this.subtitles = setterArg; }
    ...
    static SpuTracksMessage fromMap(Map<String, Object> map) {
      ...
      fromMapResult.subtitles = (Map<Object, Object>)subtitles;
      return fromMapResult;
    }
  }
  ...
  public static class AudioTracksMessage {
    ...
    private Map<Object, Object> audios;
    public Map<Object, Object> getAudios() { return audios; }
    public void setAudios(Map<Object, Object> setterArg) { this.audios = setterArg; }
    ...
    static AudioTracksMessage fromMap(Map<String, Object> map) {
      ...
      fromMapResult.audios = (Map<Object, Object>)audios;
      return fromMapResult;
    }
  }
  ...
  public static class VideoTracksMessage {
    ...
    private Map<Object, Object> videos;
    public Map<Object, Object> getVideos() { return videos; }
    public void setVideos(Map<Object, Object> setterArg) { this.videos = setterArg; }
    ...
    static VideoTracksMessage fromMap(Map<String, Object> map) {
      ...
      fromMapResult.videos = (Map<Object, Object>)videos;
      return fromMapResult;
    }
  }
  ...
  public static class RendererServicesMessage {
    ...
    public void setServices(List<Object> setterArg) { this.services = setterArg; }
    ...
    static RendererServicesMessage fromMap(Map<String, Object> map) {
      ...
      fromMapResult.services = (List<Object>)services;
      return fromMapResult;
    }
  }
  ...
  public static class RendererDevicesMessage {
    ...
    private Map<Object, Object> rendererDevices;
    public Map<Object, Object> getRendererDevices() { return rendererDevices; }
    public void setRendererDevices(Map<Object, Object> setterArg) { this.rendererDevices = setterArg; }
    ...
    static RendererDevicesMessage fromMap(Map<String, Object> map) {
      ...
      fromMapResult.rendererDevices = (Map<Object, Object>)rendererDevices;
      return fromMapResult;
    }
  }
  ...
  public interface VlcPlayerApi {
    ...
    BooleanMessage startRecord(TextureMessage arg);
    SnapshotMessage stopRecord(TextureMessage arg);
    ...
    static void setup(BinaryMessenger binaryMessenger, VlcPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VlcPlayerApi.startRecord", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              @SuppressWarnings("ConstantConditions")
              TextureMessage input = TextureMessage.fromMap((Map<String, Object>)message);
              BooleanMessage output = api.startRecord(input);
              wrapped.put("result", output.toMap());
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VlcPlayerApi.stopRecord", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              @SuppressWarnings("ConstantConditions")
              TextureMessage input = TextureMessage.fromMap((Map<String, Object>)message);
              SnapshotMessage output = api.stopRecord(input);
              wrapped.put("result", output.toMap());
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
