...
-(nullable BooleanMessage *)startRecord:(TextureMessage*)input error:(FlutterError *_Nullable *_Nonnull)error;
-(nullable SnapshotMessage *)stopRecord:(TextureMessage*)input error:(FlutterError *_Nullable *_Nonnull)error;
